...
public class GUI extends JFrame {
    ...
    private void initEvents() {
        analyzeBtn.addActionListener(e -> {
            ...
            controller.analyzeAsync(text, new Controller.AnalysisCallback() {
                @Override
                public void onSuccess(Phantich.Result result) {
                    ...
                    if(!result.sampleInput.isEmpty()) inputArea.setText(result.sampleInput);
                    if(!result.sampleOutput.isEmpty()) outputArea.setText(result.sampleOutput);
                }
        ...
        generateCodeBtn.addActionListener(e -> {
            ...
            controller.generateCodeAsync(text, type, lang, new Controller.CodeCallback() {
                @Override
